...
{
  "giftName": "ساعة ذكية",
  "giftDescription": "ساعة رياضية تدعم تتبع اللياقة والإشعارات",
  "price": 499,
...
```http
POST /api/v1/group-gifts/1/invites?userId=1
Content-Type: application/json

[
  {
    "inviteeName": "أمل",
    "inviteeEmail": "amal@example.com"
  },
  {
    "inviteeName": "نوف",
    "inviteeEmail": "nouf@example.com"
  }
]
```
...
Public group-gift voting endpoints use:

```text
http://localhost:8080/api/v1/public/group-gifts/vote/{token}
```
