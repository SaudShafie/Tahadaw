...
public class GiftQualityCheckService {
    ...
    private String buildQualityCheckPrompt(Recipient recipient,
        ...
        if (historyText.isEmpty()) {
            historyText.append("No previous gift history.");
        }
        ...
        return """
            ...
            {
              "suitability": "SUITABLE or NEUTRAL or NOT_SUITABLE",
              "strengths": "Why this gift may be a good fit",
              "weaknesses": "What could make this gift unsuitable",
              "aiAdvice": "Clear advice for the user"
            }
